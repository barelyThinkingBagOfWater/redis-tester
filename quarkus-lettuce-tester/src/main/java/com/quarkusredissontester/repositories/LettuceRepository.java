...
public class LettuceRepository {
    ...
    @Inject
    RedisStringReactiveCommands<String, String> stringReactiveCommands;

    @Inject
    RedisHashReactiveCommands<String, String> hashReactiveCommands;

    @Inject
    RedisServerReactiveCommands<String, String> serverReactiveCommands;
    ...
    public Mono<String> saveAll(List<Itinerary> itineraries) {
