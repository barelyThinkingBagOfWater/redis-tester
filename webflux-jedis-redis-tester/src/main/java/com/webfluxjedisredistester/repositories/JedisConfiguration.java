...
public class JedisConfiguration {
    ...
    public JedisConnectionFactory jedisConnectionFactory() {
        if (nodesNumber == 1) {
            RedisStandaloneConfiguration standaloneConfiguration = new RedisStandaloneConfiguration(redisSingleNodeUrl);
            log.info("Connecting to a single Redis node with Jedis and url:{}", redisSingleNodeUrl);
    ...
    public ReactiveRedisTemplate<String, String> reactiveRedisStringTemplate() {
        ...
        return new ReactiveRedisTemplate<String, String>(jedisConnectionFactory(), context);
    }
    ...
    public ReactiveRedisTemplate<String, byte[]> reactiveRedisBytesArrayTemplate() {
        ...
        return new ReactiveRedisTemplate<>(jedisConnectionFactory(), context);
    }
}
